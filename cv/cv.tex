...
\years{June 2011-\\present}\textbf{Seagate Technology}\\Sr. Engineer, \emph{Firmware Organization}\\Custom tools and infrastructure support in mostly Python and SQL.\\[.2cm]
\years{2000-present}\textbf{US Geological Survey}\\Consultant\\Java programs for seismic analysis.\\[.2cm]
...
\years{May 2004-\\Aug. 2004}\textbf{IBM}\\Intern\\Java tool to improve productivity of the printer analysis team.

\section*{Awards}

\years{2007}2$^{nd}$ place in the Colorado State University Senior Design E-days Awards in Electrical Engineering. A dual electronic \amper{} pipe organ was built an FPGA, custom windchest, and donated pipes and keyboard.\\[.1cm]
\years{2006}Wendel Diebel Award from the Colorado State University Music Department for outstanding musicianship.

\section*{Software Development}

\years{2000-present}\href{https://github.com/mjibson/slammer}{SLAMMER}\\\emph{Programs for seismic analysis in Java} (primary developer).\\[.2cm]
...
\years{2009-2010}\href{https://github.com/mjibson/missao-rio}{Mission Office}\\\emph{A system and website for management, automated statistics, and office work of a medium-sized, distributed organization in Python and Google App Engine} (creator an developer).\\[.2cm]
